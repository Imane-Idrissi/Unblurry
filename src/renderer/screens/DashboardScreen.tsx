      ...
      <header className="relative z-50 no-drag flex items-center justify-between pl-xl pr-xl pt-[46px] pb-md">
        ...
        <div className="flex items-center gap-sm">
          <button
            ...
            className={`flex items-center gap-sm rounded-md border px-md py-sm text-small font-medium shadow-sm transition-colors duration-[150ms] ${
              analyticsOn
                ? 'border-border bg-bg-elevated text-text-secondary hover:border-primary-400 hover:text-primary-600'
                : 'border-negative/30 bg-negative-bg text-negative hover:border-negative/50'
            }`}
            title={analyticsOn ? 'Analytics enabled' : 'Analytics disabled'}
          >
            <BarChartIcon />
